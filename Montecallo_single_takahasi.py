...
class RepeaterSegment:
    def __init__(self, id, n_els):
        ...
        self.succount = 0#ELの成功数
        self.loadcount = 0#QRの成功数
    ...
    def step(self, params,method,e,N_multi):
...
# --- 3. シミュレーション実行関数 ---
def run_simulation(segments, params,method,e,N_multi):
    for seg in segments:
          seg.step(params,method,e,N_multi)
...
def main_loop():
    ...
    # ==========================================
          ...
          N_multi = input("How many multipulaze?")
