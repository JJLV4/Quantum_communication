...
def main():
    ...
    def calculate_edr(param_dict, arcmethod):
        ...
        def calc_p_arc_gen(param_dict, required_single_photon_measurements=2):
            ...
            p_single_link = (1-(1-np.exp(-alpha*l)*eta_bsm*(eta_det)**required_single_photon_measurements)**gammaf) * (eta_afc)**2
        ...
        def calc_eta_qr(param_dict, sync_method = "A", required_single_photon_measurements=2):
            """
